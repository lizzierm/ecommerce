                                ...
                                @switch($option->type)
                                    ...
                                    @case(2)
                                        ...
                                        <div class="relative">
                                            ...
                                            <button class="absolute z-10 left-1 top-6 " onclick="confirmDelete({{ $feature->id }}, 'feature')">
        ...
        <x-slot name="content">
            ...
            <div class="grid grid-cols-2 gap-6 mb-4">
                <div>
                    ...
                    <x-input wire:model="newOption.name" class="w-full" placeholder="Ejemplo: Sexo"/>
                </div>
                <div>
                    <x-label class="mb-1">
                        Tipo
                        ...
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                @switch($newOption->type)
                                    @case(1)
                                        <x-input wire:model="newOption.features.{{ $index }}.value" class="w-full" placeholder="Descripcion de valor" />
                                        @break
                                    @case(2)
                            ...
                            <div>
                                ...
                                <x-input wire:model="newOption.features.{{$index}}.description" class="w-full" placeholder="Ejemplo: femenino" />
                            </div>
                        </div>
                    </div>
                @endforeach
