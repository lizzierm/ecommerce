...
<x-admin-layout :breadcrumbs="[
    ...
    <form action="{{ route('admin.covers.store') }}" 
        ...
        <figure class="relative mb-4">
            ...
            <img src="{{ asset('img/no-image.png') }}" alt="Portada" class="w-full aspect-[3/1] object-cover object-center"
            id="imgPreview">
        </figure>
        ...
        <div class="mb-4">
            ...
            <x-input name="title" value="{{old('title')}}" class="w-full" placeholder="Por favor introdusca un titulo para la portada"/>
